  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 bg-transparent hover:bg-accent hover:text-accent-foreground active:bg-accent/80 dark:bg-transparent dark:border-input dark:hover:bg-input/50",
        secondary:
        ...
        vegrin: "bg-[var(--vegrin-green-600)] text-white hover:bg-[var(--vegrin-green-700)] active:bg-[var(--vegrin-green-800)] shadow-sm focus-visible:ring-[var(--vegrin-green-500)]/50",
        "vegrin-outline": "border-2 border-[var(--vegrin-green-600)] text-[var(--vegrin-green-700)] bg-transparent hover:bg-[var(--vegrin-green-50)] active:bg-[var(--vegrin-green-100)]",
      },
      size: {
